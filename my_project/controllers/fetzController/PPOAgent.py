...
Transition = namedtuple('Transition', ['state', 'hidden', 'action', 'a_log_prob', 'reward', 'next_state'])
...
class Actor(nn.Module):
    def __init__(self, numberOfInputs, numberOfOutputs):
        ...
        self.fc1 = nn.Linear(numberOfInputs, 40)
        self.fc2 = nn.Linear(40, 40)
        self.action_head = nn.Linear(40, numberOfOutputs)
